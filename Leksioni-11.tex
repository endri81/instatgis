...
\phantomsection\label{select-limit}
\begin{itemize}
\item
...
\phantomsection\label{select-limit-1}
\AddToHookNext{env/Highlighting/begin}{\tiny}
...
\begin{frame}{Select LIMIT}
\phantomsection\label{select-limit-2}
\includegraphics{./Figs/sql16.png}
\end{frame}

\begin{frame}{Select DISTINCT}
\phantomsection\label{select-distinct}
\begin{itemize}
\item
...
\phantomsection\label{select-distinct-1}
...
\begin{frame}{Select DISTINCT}
\phantomsection\label{select-distinct-2}
\includegraphics{./Figs/sql18.png}
\end{frame}

\begin{frame}[fragile]{Select DISTINCT}
\phantomsection\label{select-distinct-3}
...
\begin{frame}{Select DISTINCT}
\phantomsection\label{select-distinct-4}
\includegraphics{./Figs/sql19.png}
\end{frame}

\begin{frame}{Select *}
\phantomsection\label{select}
\begin{itemize}
\item
...
\phantomsection\label{puxebrcaktimi-i-emrave-tuxeb-kolonave-me-as}
\AddToHookNext{env/Highlighting/begin}{\tiny}
...
\phantomsection\label{puxebrcaktimi-i-emrave-tuxeb-kolonave-me-as-1}
\includegraphics{./Figs/sql21.png}
\end{frame}

\begin{frame}[fragile]{Përcaktimi i emrave të kolonave me AS}
\phantomsection\label{puxebrcaktimi-i-emrave-tuxeb-kolonave-me-as-2}
\AddToHookNext{env/Highlighting/begin}{\tiny}
...
\begin{frame}{Select DISTINCT}
\phantomsection\label{select-distinct-5}
