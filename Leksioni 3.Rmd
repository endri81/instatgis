...
## Shkarkojmë të dhënat
  ...
  - Shkarkojmë dosjen **rar** nga linku:
...
## Analiza e avancuar me Python
  ...
  - Në këtë fazë duhet të keni një dosje të re quajtur data që përmban të dhënat. 
...
Duhet të shihni diçka si më poshtë:
...
Tani jeni gati për të vazhduar me mësimin!

## Rreth të dhënave
  
Skedarë që përshkruajnë të dhënat e motit. 
  
  - Këto dosje metadata përfshijnë:
  
  - Një listë e stacioneve: 6367598020644stn.txt
  
  - Detaje rreth vëzhgimeve të motit në çdo stacion: 6367598020644inv.txt

  - Një përshkrim të të dhënave (dmth, emrat e kolonave): 3505doc.txt
...
file_path = "data/Albania-weather-data-full/029440.txt"
