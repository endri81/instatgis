...
![](./Figs/jupyter1.png) \## Përbërësit Kryesorë të JupyterLab
...
# Programimi bazik në Python {.unnumbered}

# Matematika e Thjeshtë në Python {.unnumbered}
...
# Kombinimi i Funksioneve në Python {.unnumbered}
...
# Llojet e të Dhënave në Python {.unnumbered}
...
# Manipulimi i tekstit {.unnumbered}
...
```    
  ...
  - Funksioni **range(5)** krijon një seri numrash nga 0 deri në 4.
...
për i në range(len(qytetet)):
    print("Temperatura në", qytetet[i], "është", temperaturat[i], "gradë")
``` 
...
## Përfitimet e Përdorimit të Indeksit
